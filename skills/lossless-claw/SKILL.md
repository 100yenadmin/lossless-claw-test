---
name: lossless-claw
description: Configure, diagnose, and use lossless-claw effectively in OpenClaw, including temporal recall with lcm_recent, summary health, session lifecycle, and evidence retrieval tools.
---
...
- Recall tools and when to use them, including `lcm_recent` for time-native recall: `references/recall-tools.md`
